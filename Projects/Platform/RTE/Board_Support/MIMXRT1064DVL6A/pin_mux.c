...
- pin_list:
  ...
  - {pin_num: G13, peripheral: GPIO1, signal: 'gpio_io, 10', pin_signal: GPIO_AD_B0_10, identifier: ENET_INT, direction: OUTPUT, gpio_init_state: 'true', pull_keeper_select: Pull,
...
- pin_list:
  - {pin_num: F14, peripheral: GPIO1, signal: 'gpio_io, 09', pin_signal: GPIO_AD_B0_09, identifier: USER_LED, direction: OUTPUT, gpio_init_state: 'true', pull_keeper_enable: Disable,
    open_drain: Disable, slew_rate: Fast}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
