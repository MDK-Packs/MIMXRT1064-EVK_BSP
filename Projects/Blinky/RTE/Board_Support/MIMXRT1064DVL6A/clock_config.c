...
- {id: CCM_ANALOG.PLL4.num, value: '77', locked: true}
...
void BOARD_BootClockRUN(void)
{
    ...
    CCM_ANALOG->PLL_AUDIO_NUM = CCM_ANALOG_PLL_AUDIO_NUM_A(77);
    CCM_ANALOG->PLL_AUDIO_DENOM = CCM_ANALOG_PLL_AUDIO_DENOM_B(100);
