...
#define BOARD_INITLEDPINS_USER_LED_GPIO                                    GPIO1   /*!< GPIO device name: GPIO1 */
#define BOARD_INITLEDPINS_USER_LED_PORT                                    GPIO1   /*!< PORT device name: GPIO1 */
#define BOARD_INITLEDPINS_USER_LED_PIN                                        9U   /*!< GPIO1 pin index: 9 */
...
#define BOARD_INITBUTTONSPINS_USER_BUTTON_GPIO                             GPIO5   /*!< GPIO device name: GPIO5 */
#define BOARD_INITBUTTONSPINS_USER_BUTTON_PORT                             GPIO5   /*!< PORT device name: GPIO5 */
#define BOARD_INITBUTTONSPINS_USER_BUTTON_PIN                                 0U   /*!< GPIO5 pin index: 0 */
